...
/**
 * OverviewSection — DetailSection 'Overview' (defaultOpen) for routine-panel.
 *
 * Workflows.md ladder: description, variables list, sharing detail summary,
 * created/updated relative times. Honest summary copy ("Shared with 3 roles"
 * or "Private") — no lies about what RBAC actually applies.
 */
...
export function OverviewSection({ routine }: { routine: Routine }) {
    ...
    <DetailSection title={t("overview.title")} defaultOpen={true}>
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm">{sharingSummary(routine, t as unknown as SharingT)}</p>
        </div>
